...
- [ ]  지도
    - [x]  지도에서 원의 색깔 통일
    - [x]  해당 화면 top 3 역은 두껍게 강조 + 애니매이션
    - [x]  Select 된 역이 생기면 색 다르게 하고, 나머지 원들 색 흐리게
    - [ ]  *지도 자체에 대한 고민 (너무 글이 많음)
- [ ]  Zooming
    - [ ]  우측 상단 zooming bar 없애기
    - [x]  Zooming 시 각 역의 동그라미 크기 유지되도록 설계
    - [x]  Zooming 하더라도 기준 컬럼에 대한 top3 역에는 변동 없도록 설계 (좌측 상단)
